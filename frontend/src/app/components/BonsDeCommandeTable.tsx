...
const columns: ColumnDef<BonDeCommande>[] = [
...
export function BonsDeCommandeTable({ data }: Props) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center">
        ...
        <div className="ml-auto text-sm text-gray-500">
          {table.getFilteredRowModel().rows.length} sur {data.length} bons de commande
        </div>
      </div>
