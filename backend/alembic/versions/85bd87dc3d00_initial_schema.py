...
Revision ID: 85bd87dc3d00
Revises: 
Create Date: 2026-04-27 14:30:59.363285
...
def upgrade() -> None:
    ...
    op.create_table('office_licence',
    ...
    op.create_index(op.f('ix_office_licence_type_licence'), 'office_licence', ['type_licence'], unique=False)
    op.create_index(op.f('ix_office_licence_version'), 'office_licence', ['version'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_office_licence_version'), table_name='office_licence')
    op.drop_index(op.f('ix_office_licence_type_licence'), table_name='office_licence')
    op.drop_table('office_licence')
