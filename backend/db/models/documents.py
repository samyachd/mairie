...
class Devis(Document):
    ...
    officelicence: Mapped[list["OfficeLicence"]] = relationship(back_populates="devis")
...
class BonDeCommande(Document):
    ...
    officelicence: Mapped[list["OfficeLicence"]] = relationship(back_populates="bon_de_commande")
...
class Facture(Document):
    ...
    officelicence: Mapped[list["OfficeLicence"]] = relationship(back_populates="facture")