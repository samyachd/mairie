...
class OfficeLicense(BaseEntry):
    ...
    ordinateur: Mapped[list["Ordinateur"]] = relationship(back_populates="office_license", passive_deletes=True)
    devis: Mapped[Optional["Devis"]] = relationship(back_populates="office_license")
    bon_de_commande: Mapped[Optional["BonDeCommande"]] = relationship(back_populates="office_license")
    facture: Mapped[Optional["Facture"]] = relationship(back_populates="office_license")
